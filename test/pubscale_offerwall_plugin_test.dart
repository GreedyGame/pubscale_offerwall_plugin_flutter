...
void main() {
  final PubscaleOfferwallPluginPlatform initialPlatform =
      PubscaleOfferwallPluginPlatform.instance;

  test('$MethodChannelPubscaleOfferwallPlugin is the default instance', () {
    expect(
      initialPlatform,
      isInstanceOf<MethodChannelPubscaleOfferwallPlugin>(),
    );
  });

  test('getPlatformVersion', () async {
    PubscaleOfferwallPlugin pubscaleOfferwallPlugin = PubscaleOfferwallPlugin();
    MockPubscaleOfferwallPluginPlatform fakePlatform =
        MockPubscaleOfferwallPluginPlatform();
